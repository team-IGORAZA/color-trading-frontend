...
const MenuSection: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className="bg-[#020A4A] rounded-xl p-4 mb-4">
    {children}
  </div>
);
...
const ProfileMenu: React.FC = () => {
  return (
    <div className="max-w-2xl  mx-auto p-4">
      <MenuSection>
        <MenuItem 
          icon={<svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" /></svg>}
          label="Transactions"
        />
        <MenuItem 
        ...
        />
        <MenuItem 
          icon={<svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" /></svg>}
          label="Language"
        />
      </MenuSection>
